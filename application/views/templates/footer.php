        <div class="section footer">
            <div class="row footer-menu-wrapper">
                <div class="col s6 m6 l3 footer-box-wrapper" style="padding:35px 20px 50px 20px;background-color:#f5f5f5;">
                    ...
                    <a href="<?php echo site_url('about'); ?>"><span class="footer-submenu">Tentang Kami</span></a><br/>
                ...
                <div class="col s6 m6 l3 footer-box-wrapper" style="padding:35px 20px 50px 20px;background-color:#e0e0e0;">
                    <img alt="logo kelastutorial" style="width:80%;margin-top:15px;" src="<?php echo site_url('images/kelastutorial-logo.svg'); ?>"/><br>
