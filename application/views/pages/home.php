        <div class="wall-home card">
            ...
            <form onsubmit="location.href='https://kelastutorial.com/search?q=' + document.getElementsByClassName('searchInput').value; return false;">
                <input class="hoverable searchInput" style="border-radius:2px;background-color:#fff;padding:0 30px 0 30px;font-size:15px;width:50%" type="text" placeholder="Cari Tutorial"/>
            </form>
        </div>
