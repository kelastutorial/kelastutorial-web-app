                    ...
                    <div class="about-this-tutorial">
                        ...
                        <div class="row" style="margin-top:50px;">
                            ...
                            <div class="col s12 m12 l6">
                                <a href="./git/pengertian-git.git" style="width:100%;margin-bottom:13px;" class="waves-effect waves-light btn-large  deep-orange darken-1"><i class="material-icons right">school</i>pelajari</a>
                            </div>
                            <div class="col s12 m12 l6">
        ...
        <div class=" deep-orange darken-1 syllabus-tutorial-container" id="git-syllabus">
            <div class="container">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <div class="row syllabus-content">
                                    <div class="col s12 m6 l6">
                                        <ol type="i">
                                            <li><a href="./git/pengertian-git.git">Pengertian HTML</a></li>
