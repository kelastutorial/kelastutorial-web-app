                ...
                <div class="col s12 m12 l3 hide-on-tablet">
                    <div class="left-sidebar-container">
                        <div class="grey lighten-3 left-sidebar">
                            ...
                            <a href='<?php echo site_url('git/pengertian-git.html'); ?>'>Pengertian Git</a>
                            <a href='<?php echo site_url('git/sejarah-git.html'); ?>'>Sejarah Git</a>
                            <a href='<?php echo site_url('git/versi-git.html'); ?>'>Versi Git</a>
                            <a href='<?php echo site_url('git/instalasi-git.html'); ?>'>Instalasi Git</a>
                            <a href='<?php echo site_url('git/menjalankan-git.html'); ?>'>Menjalankan Git</a>
                        </div>
                        <div class="grey lighten-3 left-sidebar">
                            <span class="subtutorial">Git Dasar</span><br/>
                            <a href='<?php echo site_url('git/life-cycle-git.html'); ?>'>Life Cycle Git Git</a>
                            <a href='<?php echo site_url('git/operasi-create-git.html'); ?>'>Operasi Create Git</a>
                            <a href='<?php echo site_url('git/operasi-clone-git.html'); ?>'>Operasi Clone Git</a>
                            <a href='<?php echo site_url('git/perubahan-perform-git.html'); ?>'>Perubahan Perform Git</a>
                            <a href='<?php echo site_url('git/perubahan-commit-git.html'); ?>'>Perubahan Commit Git</a>
                            <a href='<?php echo site_url('git/operasi-push-git.html'); ?>'>Operasi Push Git</a>
                            <a href='<?php echo site_url('git/operas-update-git.html'); ?>'>Operasi Update Git</a>
                            <a href='<?php echo site_url('git/operasi-stash-git.html'); ?>'>Operasi Stash Git</a>
                            <a href='<?php echo site_url('git/opperasi-move-git.html'); ?>'>Operasi Move Git</a>
                            <a href='<?php echo site_url('git/operasi-rename-git.html'); ?>'>Operasi Rename Git</a>
                            <a href='<?php echo site_url('git/operasi-delete-git.html'); ?>'>Operasi Delete Git</a>
                            <a href='<?php echo site_url('git/memperbaiki-kesalahan-git.html'); ?>'>Mempebaiki Kesalahan Git</a>
                            <a href='<?php echo site_url('git/operasi-tag-git.html'); ?>'>Operasi Tag Git</a>
                            <a href='<?php echo site_url('git/operash-patch-git.html'); ?>'>Operasi Patch Git</a>
                            <a href='<?php echo site_url('git/mengatur-branch-git.html'); ?>'>Mengatur Branch Git</a>
                            <a href='<?php echo site_url('git/menangani-konflik-git.html'); ?>'>Menangani Konflik Git</a>
                            <a href='<?php echo site_url('git/multi-platform-git.html'); ?>'>Multi Platform Git</a>
                        </div>
                    </div>
                </div>
