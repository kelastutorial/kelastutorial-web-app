            ...
            <div class="row">
                <div class="col s12 m6 l6">
                    <div class="about-this-tutorial">
                        <h4 class="tutorials-index-head-four" style="color:#444;">Tentang Format JSON</h4>
                        ...
                        <div class="row" style="margin-top:50px;">
                            ...
                            <div class="col s12 m12 l6">
                                <a href="./json/pengertian-json.html" style="width:100%;margin-bottom:13px;" class="waves-effect waves-light btn-large  grey darken-4"><i class="material-icons right">school</i>pelajari</a>
                            </div>
                            <div class="col s12 m12 l6">
        ...
        <div style="background-color: #FAF0E6;" class="syllabus-tutorial-container" id="json-syllabus">
            <div class="container">
                <h4 class="tutorials-index-head-four" style="color:#444;text-align:center">Apa yang akan Anda pelajari ?</h4>
