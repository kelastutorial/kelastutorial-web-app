                ...
                <div class="col s12 m12 l9">
                    <div class="red darken-1 main-content-nav">
                        ...
                        <a href="<?php echo site_url("xml") ?>" class="main-content-nav-title">HTML</a>
                        <a class="main-content-nav-title">></a>
                        <a href="<?php echo site_url("xml") ?>/<?php echo $item['slug']; ?>.xml" class="main-content-nav-title"><h1 class="main-content-heading"><?php echo $item['title']; ?></a>
                    </div>
