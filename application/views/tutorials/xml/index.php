            ...
            <div class="row">
                    ...
                    <div class="about-this-tutorial">
                        ...
                        <div class="row" style="margin-top:50px;">
                            ...
                            <div class="col s12 m12 l6">
                                <a href="./xml/pengertian-xml.xml" style="width:100%;margin-bottom:13px;" class="waves-effect waves-light btn-large  deep-orange darken-1"><i class="material-icons right">school</i>pelajari</a>
                            </div>
                            <div class="col s12 m12 l6">
                                <a href="#xml-syllabus" style="width:100%" class="waves-effect waves-light btn-large grey lighten-1">lihat materi</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col s12 m6 l6">
                    <div class="center" style="padding:30px 0 30px 0;">
                        <img style="width:60%;" alt="logo xml" title="logo xml" src="https://kelastutorial.com/images/xml-logo.png"/>
                    </div>
        ...
        <div class=" deep-orange darken-1 syllabus-tutorial-container" id="xml-syllabus">
            <div class="container">
                        ...
                        <li>
                            ...
                            <div class="collapsible-body">
                                <div class="row syllabus-content">
                                    <div class="col s12 m6 l6">
                                        <ol type="i">
                                            <li><a href="./xml/pengertian-xml.xml">Pengertian HTML</a></li>
