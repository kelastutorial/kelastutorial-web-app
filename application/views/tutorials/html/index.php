            ...
            <div class="row">
                    ...
                    <div class="about-this-tutorial">
                        ...
                        <div class="row" style="margin-top:50px;">
                            ...
                            <div class="col s12 m12 l6">
                                <a href="./html/pengertian-html.html" style="width:100%;margin-bottom:13px;" class="waves-effect waves-light btn-large  deep-orange darken-1"><i class="material-icons right">school</i>pelajari</a>
                            </div>
                            <div class="col s12 m12 l6">
                ...
                <div class="col s12 m6 l6">
                    <div class="center" style="padding:30px 0 30px 0;">
                        <img style="width:60%;" alt="logo html" title="logo html" src="https://kelastutorial.com/images/html-logo.png"/>
                    </div>
